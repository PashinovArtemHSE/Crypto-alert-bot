...
```
git clone https://github.com/PashinovArtemHSE/Crypto-alert-bot.git
```
...
```
- **Запустите бот по ссылке в Телеграмм: [@Crypto Alert Bot](https://t.me/from_durashki_crypto_bot)**
...
- **Частота проверки**: каждые 60 секунд
...
| Пашинов Артём     | [@amstr06](https://t.me/amstr06) | • Анализ данных<br>• Тестирование<br>• Написание Readme для пользователей|
